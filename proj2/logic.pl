...
move_stack(Board, [LastMove], Row/Col, [LastChar], [NewBoard | NT]) :- last(ChosenStack, LastChar),
                                                                        new_coordinates(Row/Col, LastMove, NewRow/NewCol),
...
game_over(GameState, TurnsLeft) :- TurnsLeft < 1, format('~nAfter a true display of skill, the match unfortunately ends in a draw.~n~nGAME OVER~n~n').
